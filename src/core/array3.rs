...
impl<A> A3<A> {
    ...
    #[inline(always)]
    pub fn a2(a2: A2<A>, a: A) -> A3<A> {
        let A2(x, y) = a2;
        A3(x, y, a)
    }

    #[inline(always)]
    pub fn map<B>(self, f: impl Fn(A) -> B) -> A3<B> {
...
impl<A> A3<A3<A>> {
    #[inline(always)]
    pub fn unzip<B>(self, f: impl Fn(A, A, A) -> B) -> A3<B> {
