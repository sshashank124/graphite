...
impl Affine3 {
    #[inline(always)] pub const fn new(r: RotScale3, t: F3) -> Self { Self { r, t } }

    #[inline(always)] pub fn translate(t: F3) -> Self { Self::new(RotScale3::ONE, t) }
    ...
    #[inline(always)] pub fn rot(&self) -> Self { Self::new(self.r, F3::ZERO) }
    #[inline(always)] pub fn t(&self) -> Self { Self::new(self.r.t(), F3::ZERO) }
}
